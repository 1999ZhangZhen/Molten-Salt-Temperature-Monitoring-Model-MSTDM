...
%% 导入数据
res = xlsread('C:\Users\zhangzhen\Documents\MATLAB\wendu\experiment there\Laboratory dataset.xlsx');
...
ALL_feature_2 = ALL_feature_1';
ALL_sim = [ones(1478, 1), ALL_feature_2] * betaPLS;
